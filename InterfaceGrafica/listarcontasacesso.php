...
<html>
    <head>
        ...
        <title>Listar Contas De Acesso</title>
    </head>
    <body>
        <div class="container-fluid">
            ...
            if ($tipo == 1) {
                if ($procurar != "") {
                    $sql = "SELECT * FROM contadeacesso WHERE idContaDeAcesso = $procurar ORDER BY idContaDeAcesso";
                } else {
                    $sql = "SELECT * FROM contadeacesso ORDER BY idContaDeAcesso";
                }
            } else if ($tipo == 2) {
                ...
                if ($procurar != "") {
                    ...
                    $sql = "SELECT * FROM contadeacesso ORDER BY tipodeacesso";
                }
            }
                ...
                <tbody>
                    <?php for ($index = 0; $index < $count; $index++) {
                        ...
                        <tr>
                            ...
                            <?php $linkscript = ".." . DIRECTORY_SEPARATOR . "arquivosPHP" . DIRECTORY_SEPARATOR . "exclusaoContaDeAcesso?conta=" . $number ?>

                            <td class="table-success"><button  type="button" id="btn1" onclick="ExcludeContaDeAcesso(<?php echo $linkscript ?>)" > <img src=<?php echo $linkimgapagar?>></button></td>
