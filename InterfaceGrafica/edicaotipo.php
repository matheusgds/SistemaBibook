...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="divform"id="divform">
                <?php $link = ".." . DIRECTORY_SEPARATOR . "arquivosPHP" . DIRECTORY_SEPARATOR . "editartipo.php"; ?>

            <form action=<?php echo $link ?> id="form" method="post">

                <fieldset>
                    <legend>
                        Editar Tipo De Livro
                    </legend>
                    <label for="codigoid">Codigo:</label>
                    <input  readonly="" type="text" name="codigoid" id="codigoid" value="<?php echo $_GET['tipo'] ?>">
                    <br><br>
                    <label for="tipo">Tipo De Livro:</label>
                    <input type="text" name="tipo" id="tipo"  required="true" value="<?php retornaTipo($_GET['tipo']) ?>"> 
                    <br><br>
                    <label for="tipo">Código Tipo De Livro:</label>
                    <input type="text" name="codigo" id="codigo"  required="true" value="<?php retornaCodigo($_GET['tipo']) ?>"> 
                    <br><br>
    ...
    function retornaTipo($valor) {
        ...
        $sql = "select nome from TipoDeLivro where idTipoDeLivro= '$valor' ";
