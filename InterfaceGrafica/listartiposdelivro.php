...
<html>
                ...
                <tbody>
                    <?php for ($index = 0; $index < $count; $index++) {
                        ...
                        <tr>
                            ...
                            <?php $link = "exclusaotipo.php?tipo=" . $number; ?>
                            <td class="table-success"><button  type="button" id="btn1" onclick="EditTipo(<?php echo $number ?>)" ><img src="../IMG/Edit.png"> </button></td>
                            <td class="table-success"><button  type="button" id="btn1" onclick="ExcludeTipo(<?php echo $number ?>)" > <img src="../IMG/Erase.png"></button></td>
                        </tr>
    ...
    <script type='text/javascript'>
        ...
        function ExcludeTipo(valor) {

            var a = confirm('Deseja Mesmo Excluir?');

            if (a === true) {
                var link = "exclusaotipo.php?tipo=";
                link = link + valor;
