...
<html>
                ...
                <tbody>
                    <?php for ($index = 0; $index < $count; $index++) {
                        ...
                        <tr>
                            ...
                            <td class="table-success"><button  type="button" id="btn1" onclick="EditEditora(<?php echo $number ?>)" ><img src="../IMG/Edit.png"> </button></td>
                            <td class="table-success"><button  type="button" id="btn1" onclick="ExcludeEditora(<?php echo $number ?>)" > <img src="../IMG/Erase.png"></button></td>
                        </tr>
    ...
    <script type='text/javascript'>
        ...
        function ExcludeEditora(valor) {

            var a = confirm('Deseja Mesmo Excluir?');

            if (a === true) {
                var link = "exclusaoEditora.php?editora=";
                link = link + valor;
