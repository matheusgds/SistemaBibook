...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="divform"id="divform">
            <?php $link = ".." . DIRECTORY_SEPARATOR . "arquivosPHP" . DIRECTORY_SEPARATOR . "editareditora.php"; ?>
            ...
            <form action=<?php echo $link ?> id="form" method="post">
                ...
                <fieldset>
                    ...
                    <input  readonly="" type="text" name="codigo" id="codigo" value="<?php echo $_GET['editora'] ?>">
                    <br><br>
                    <label for="nome">Nome:</label>
                    <input type="text" name="nome" id="nome"  required="true" value="<?php retornaNome($_GET['editora']) ?>"> 
