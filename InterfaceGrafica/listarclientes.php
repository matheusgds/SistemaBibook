...
<html>
    ...
    <body>
        <div class="container-fluid">
           <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            ...
            if ($tipo == 1) {
                if ($procurar != "") {
                    $sql = "SELECT * FROM Cliente WHERE idCliente = $procurar ORDER BY idCliente";
                } else {
            ...
            $vet = $Cliente->PesquisarTodos($sql);
            $count = count($vet);
            ?>
            <br><br>
            <h1>Dados:</h1>
            ...
            <table class="table table-striped table-hover" border="1px" bgcolor="#9dff8c">
                <thead>
                    <tr> 
                        ...
                        <th scope="col" bgcolor="#78ad6f">CPF</th>
                        <th scope="col" bgcolor="#78ad6f">RG</th>
                        <th scope="col" bgcolor="#78ad6f">Data Nascimento</th>
                        <th scope="col" bgcolor="#78ad6f">Sexo</th>
                        <th scope="col" bgcolor="#78ad6f">Situacao</th>
                        ...
                        <th scope="col" bgcolor="#78ad6f">Conta De Acesso</th>
                ...
                <tbody>
                    <?php for ($index = 0; $index < $count; $index++) {
                        ...
                        <tr>
                            ...
                            <td class="table-success"><?php echo $vet[$index]->getContaacesso(); ?></td>
                            ...
                            <?php $linkscript = ".." . DIRECTORY_SEPARATOR . "arquivosPHP" . DIRECTORY_SEPARATOR . "exclusaoCliente.php?cliente=" . $number ?>
                            <td class="table-success"><button  type="button" id="btn1" onclick="EditCliente(<?php echo $number ?>)" ><img src=<?php echo $linkimgeditar ?>> </button></td>
                            <td class="table-success"><button  type="button" id="btn1" onclick="ExcludeCliente(<?php echo $linkscript ?>)" > <img src=<?php echo $linkimgapagar ?>></button></td>
                        </tr>
    ...
    <script type='text/javascript'>
        ...
        function EditCliente(valor) {
            var link = "edicaocliente.php?cliente=";
            link = link + valor;
            window.location.href = link;
        }
