...
<html>
    <head>
        ...
        <title>Cadastro De Numero De Casa</title>
    </head>
    <body>
        ...
        <div class="container-fluid">
           <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            ...
            <div class="divform"id="divform">
                <?php $link = ".." . DIRECTORY_SEPARATOR . "arquivosPHP" . DIRECTORY_SEPARATOR . "insercaoNumeroCasa.php"; ?>

                <form action=<?php echo $link?> id="form" method="post">

                    <fieldset>
                        <legend>
                            Cadastro De Numero De Casa
                        </legend>
                        <label for="nome">Numero Da Casa:</label>
                        <input type="text" name="numero" id="numero" placeholder="Numero" required="true">
                        <br><br>
