...
CREATE TABLE IF NOT EXISTS `SistemaBibook`.`Cliente` (
  ...
  INDEX `fk_Cliente_Cidade1_idx` (`Cidade_idCidade` ASC) VISIBLE,
  INDEX `fk_Cliente_Bairro1_idx` (`Bairro_idBairro` ASC) VISIBLE,
  INDEX `fk_Cliente_Rua1_idx` (`Rua_idRua` ASC) VISIBLE,
  INDEX `fk_Cliente_NumeroCasa1_idx` (`NumeroCasa_idNumeroCasa` ASC) VISIBLE,
  INDEX `fk_Cliente_Contato1_idx` (`Contato_idContato` ASC) VISIBLE,
  INDEX `fk_Cliente_ContaDeAcesso1_idx` (`ContaDeAcesso_idContaDeAcesso` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SistemaBibook`.`Rua_has_Bairro` (
  ...
  INDEX `fk_Rua_has_Bairro_Bairro1_idx` (`Bairro_idBairro` ASC) VISIBLE,
  INDEX `fk_Rua_has_Bairro_Rua1_idx` (`Rua_idRua` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SistemaBibook`.`Estado_has_Cidade` (
  ...
  INDEX `fk_Estado_has_Cidade_Cidade1_idx` (`Cidade_idCidade` ASC) VISIBLE,
  INDEX `fk_Estado_has_Cidade_Estado1_idx` (`Estado_idEstado` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SistemaBibook`.`Cidade_has_Bairro` (
  ...
  INDEX `fk_Cidade_has_Bairro_Bairro1_idx` (`Bairro_idBairro` ASC) VISIBLE,
  INDEX `fk_Cidade_has_Bairro_Cidade1_idx` (`Cidade_idCidade` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SistemaBibook`.`Administrador` (
  ...
  INDEX `fk_Administrador_Cliente1_idx` (`Cliente_idCliente` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SistemaBibook`.`Bibliotecario` (
  ...
  INDEX `fk_Bibliotecario_Cliente1_idx` (`Cliente_idCliente` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SistemaBibook`.`Biblioteca` (
  ...
  INDEX `fk_Biblioteca_Estado1_idx` (`Estado_idEstado` ASC) VISIBLE,
  INDEX `fk_Biblioteca_Cidade1_idx` (`Cidade_idCidade` ASC) VISIBLE,
  INDEX `fk_Biblioteca_Bairro1_idx` (`Bairro_idBairro` ASC) VISIBLE,
  INDEX `fk_Biblioteca_Rua1_idx` (`Rua_idRua` ASC) VISIBLE,
  INDEX `fk_Biblioteca_NumeroCasa1_idx` (`NumeroCasa_idNumeroCasa` ASC) VISIBLE,
  INDEX `fk_Biblioteca_Contato1_idx` (`Contato_idContato` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SistemaBibook`.`LocalDePublicacao` (
  ...
  INDEX `fk_LocalDePublicacao_Estado1_idx` (`Estado_idEstado` ASC) VISIBLE,
  INDEX `fk_LocalDePublicacao_Cidade1_idx` (`Cidade_idCidade` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SistemaBibook`.`Livro` (
  ...
  PRIMARY KEY (`idLivro`),
  INDEX `fk_Livro_LocalDePublicacao1_idx` (`LocalDePublicacao_idLocalDePublicacao` ASC) VISIBLE,
  INDEX `fk_Livro_Editora1_idx` (`Editora_idEditora` ASC) VISIBLE,
  INDEX `fk_Livro_Edicao1_idx` (`Edicao_idEdicao` ASC) VISIBLE,
  INDEX `fk_Livro_AnoDePublicacao1_idx` (`AnoDePublicacao_idAnoDePublicacao` ASC) VISIBLE,
  INDEX `fk_Livro_TipoDeLivro1_idx` (`TipoDeLivro_idTipoDeLivro` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SistemaBibook`.`Livro_has_locacao` (
  ...
  INDEX `fk_Livro_has_locacao_locacao1_idx` (`locacao_idlocacao` ASC) VISIBLE,
  INDEX `fk_Livro_has_locacao_Livro1_idx` (`Livro_idLivro` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SistemaBibook`.`Fornecedor` (
  ...
  INDEX `fk_Fornecedor_Estado1_idx` (`Estado_idEstado` ASC) VISIBLE,
  INDEX `fk_Fornecedor_Cidade1_idx` (`Cidade_idCidade` ASC) VISIBLE,
  INDEX `fk_Fornecedor_Bairro1_idx` (`Bairro_idBairro` ASC) VISIBLE,
  INDEX `fk_Fornecedor_Rua1_idx` (`Rua_idRua` ASC) VISIBLE,
  INDEX `fk_Fornecedor_NumeroCasa1_idx` (`NumeroCasa_idNumeroCasa` ASC) VISIBLE,
  INDEX `fk_Fornecedor_Contato1_idx` (`Contato_idContato` ASC) VISIBLE,
